...
Page({
  ...
  onLoad: function (e) {
    ...
    WxParse.wxParse('article', 'html', '<img src="../../image/img1.jpeg"></img><img src="../../image/detail.jpg"></img><div>美白护肤</div>', that, 5);
    // wx.request({
  ...
  */
  ...
  reputation: function (goodsId) {
    ...
    this.setData({
      reputation: [{
        user:{
          user: '../../image/touxiang.gif',
        },
        goods: {
          goodReputationStr: '扯扯.冯',
          goodReputationRemark: '专门买给丑丑用的',
          dateReputation: '2018-08-03',
          property: 'VIP3'
        }
      }]
    })
